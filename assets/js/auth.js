...
(function () {
  ...
  function renderAuthHeaderDropdown(user, activeRole) {
    ...
    if (user) {
      ...
      toggle.innerHTML = '<div class="svg-icn">' + ICON_USER + '</div>'
        + '<span class="top-nav-link-label">' + toggleLabel + '</span>'
        + '<div class="svg-icn dropdown-chevron">' + ICON_CHEVRON + '</div>';
      ...
      logoutItem.innerHTML = '<div class="svg-icn">' + ICON_LOGOUT + '</div>'
        + '<span>Log out</span>';
