...
<div class="demo-preview is-joined">
  <div class="block row gap-m" style="flex-wrap: wrap; align-items: center;">
    ...
    <button class="button is-icon" aria-label="Icon"><div class="icn-svg" data-icon="add"><svg width="100%" height="100%" viewBox="0 0 24 24" fill="none"><path d="M11 13H5V11H11V5H13V11H19V13H13V19H11V13Z" fill="currentColor"/></svg></div></button>
  </div>
</div>
