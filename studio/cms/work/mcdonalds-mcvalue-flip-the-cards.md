...
stat:
  ...
  icon: arrow-up
title: "How we drove McDonald's McValue launch to 442% higher engagement with a gamified experience"
synopsis: "We designed and built a gamified experience for McDonald's McValue launch. A personalised card game built around Black Gen-Z lifestyle moments. 703K visitors. 3.6M impressions. Idea to launch in 8 weeks."
date: 2026-04-29
client: "McDonald's"
logo: mcdonalds
year: 2026
services: ["Creative Strategy", "Creative Direction", "Art Direction", "UI/UX Design", "Game Design", "Copywriting", "Development", "Project Management"]
...
{{grid cols="2"}}
{{img src="https://bydefault.design/image/800x1000" alt="McValue card game lifestyle moment" ratio="4:5"}}
{{img src="https://bydefault.design/image/800x1000" alt="McValue combo match reveal" ratio="4:5"}}
{{/grid}}

{{img src="https://bydefault.design/image/1920x1080" ratio="16:9"}}

{{grid cols="3"}}
{{img src="https://bydefault.design/image/540x960" alt="Lifestyle moment card one" ratio="9:16"}}
{{img src="https://bydefault.design/image/540x960" alt="Lifestyle moment card two" ratio="9:16"}}
{{img src="https://bydefault.design/image/540x960" alt="Lifestyle moment card three" ratio="9:16"}}
{{/grid}}

{{img src="https://bydefault.design/image/1920x1080" ratio="16:9"}}

{{grid cols="2"}}
{{img src="https://bydefault.design/image/800x1000" alt="In-game UI with menu and scoreboard" ratio="4:5"}}
{{img src="https://bydefault.design/image/800x1000" alt="Promo voucher reward screen" ratio="4:5"}}
{{/grid}}
